...
Estos textos están ligeramente preparados, pues he unido todos los párrafos y cada elemento de cada uno de los vectores contiene un capítulo. Podrías haberlo hecho cargando los ficheros sin modificar, pero habría sido enredar un tanto la explicación y quiero que te centres en el análisis de sentimientos.

El siguente paso es crear un vector de caracteres con el título de cada entrega, llámalo, evidentemente, `titulo`. Créalo en el orden cronológico de publicación, así el análisis será mucho más interesante. Además, las máquinas tienen la tendencia a presentar las cosas en orden alfabético. Fíjate que cargaste los episodios en orden cronológico, pero en **Global Environment** los tienes en orden alfabético.
